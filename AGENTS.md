...
**External copies of the authoring skill (parity watch).** The open
submission PR NousResearch/hermes-agent#61632 carries an external copy
of the authoring `SKILL.md` body (frontmatter is theirs; the BODY is
ours). Every kit-side skill bump refreshes each open copy in the same
move — parity is re-verified by
...
of the watched PRs merges or closes, move it from this watch into its
